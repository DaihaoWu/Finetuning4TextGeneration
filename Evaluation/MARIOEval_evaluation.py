...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=False,
        choices=['controlnet', 'deepfloyd', 'stablediffusion', 'textdiffuser', 'lora_stablediffusion']
    )
    parser.add_argument(
        "--gpu",
        type=int,
...
if __name__ == "__main__":
    ...
    datasets_with_images = ['TMDBEval500']
    datasets = ['TMDBEval500']
    # methods = ['textdiffuser', 'controlnet', 'deepfloyd', 'stablediffusion']
    methods = ['stablediffusion', 'lora_stablediffusion', 'enhanced_lora_stablediffusion'] 
    # methods = ['enhanced_lora_stablediffusion'] 
